...
def make_shell_ctx():
    return {'dbs': dbs, 'User': User, 'Qualifying_Answer': Qualifying_Answer, 'User': User, 'Client': Client, 'Conviction': Conviction, 'Charge': Charge, 'charge_types': charge_types, 'class_types': class_types, 'user_types': user_types }
